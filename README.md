...
Your agent installs the [skill](./skills/agenthook-ai-influencer-ugc-video/SKILL.md), sends you a link to approve (new accounts get 30 trial credits), and comes back with an image URL. Nothing else to configure — and enough trial credits are left for a reusable influencer too.
