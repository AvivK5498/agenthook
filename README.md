...
[![npm](https://img.shields.io/badge/npm-placeholder--name-c6fe1e?style=flat-square)](https://www.npmjs.com/package/placeholder-name)
...
```bash
npm i -g placeholder-name
placeholder-name login
placeholder-name run make_video \
...
Agent: runs placeholder-name, returns the finished MP4.
```
...
Full quickstart, tool reference, and API docs: **docs coming online with launch** — until then, `placeholder-name tools` prints every tool and argument straight from the API.
